  ...
  <div class="row justify-content-center">
    <div class="card card-info">
      <div class="card-header bg-tosca">
        <h3 class="card-title"><i class="fa fa-car"></i> Form Tambah Mobil</h3>
      </div>
      <div class="col-md-12">
        <div class="card-body">
          <form role="form" action="<?php echo base_url('mobil/insertMobil') ?>" method="post" enctype="multipart/form-data">
            <div class="col-sm-12">
              <div class="form-group input-group-sm">
                <label class="text-sm mb-0">Nama</label>
                <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Mobil" value="<?php echo set_value('nama') ?>">
